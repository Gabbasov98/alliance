...
$(".catalog-search__btn").click(function () {
    $(".catalog-search").toggleClass("_open");
})


$(document).mouseup( function(e){
    let div = $( ".catalog-search" );
    if ( !div.is(e.target)
...
$(".filter-item").each(function () {
    let filter = $(this)
    let toggle = $(this).find(".filter-item__show")
    let input = $(this).find(".filter-item__show input")
    let selected = $(this).find(".filter-item__dropdown ._selected")
